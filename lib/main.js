...
exports.main = function() {
    ...
    /* Test if the inbox page has been patched else reload to get it patched.
       Fixes two problems. Sometimes the register functions is too late,
    ...
    pageMod.PageMod({
        ...
        contentScript:
            'if (document.getElementsByClassName("unsupportedText").length != 0)' +
